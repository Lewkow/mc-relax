...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # please see the online documentation at vagrantup.com.
	...
	config.vm.hostname = "mc-relax"

	config.vm.provider "virtualbox" do |v|
		###
		### GOOD SETTINGS FOR LAPTOP
		### 4 GB / 2 cpus
		###
		v.memory = 4096
		v.cpus = 2
		###
		### GOOD SETTINGS FOR MAC PRO
		### 16 GB / 10 cpus
		###
		#v.memory = 16384
		#v.cpus = 10
  ...
  config.vm.network "forwarded_port", guest: 7888, host: 7888
	...
	#	master.vm.provision :shell, path: "pre_built_spark.sh"
	#end

  # Every Vagrant virtual environment requires a box to build off of.
  #config.vm.box = "hashicorp/precise64"
  #config.vm.provision :shell, path: "pre_built_spark.sh"	
  #config.vm.provision :shell, path: "build_spark.sh"	
  ...
  # config.vm.synced_folder "../../", "/home/vagrant/openlap"
